...
=item db_last_mod, optional

Date of db export as a text string. Information written into the html index
...
if ($opts{db_last_mod}) {
  my $add_header = "Export von gourmet db vom  $opts{db_last_mod}";
